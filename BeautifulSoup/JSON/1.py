...
for page in range(1, pagen + 1):
    ...
    for card in soup.find_all('div', class_='item_card'):
        ...
        data = {
            ...
            "Цена": soup.find('p', class_='price').text.strip()
        }

        result_json.append(data)
with open('BeautifulSoup/JSON/res.json', 'w', encoding='utf-8-sig', newline='') as file:
