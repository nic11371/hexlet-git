...
with webdriver.Chrome(options=chrome_options) as browser:
    base_url = 'https://captcha-parsinger.ru'
    browser.get('https://captcha-parsinger.ru/')
    pages = []
    categories = browser.find_elements(By.CSS_SELECTOR, "a.chakra-link")
    links = list({link.get_attribute("href") for link in categories if link.get_attribute("href")})
