...
base_sizes_x = [516, 648, 680, 701, 730, 750, 805, 820, 855, 890, 955, 1000]
base_sizes_y = [270, 300, 340, 388, 400, 421, 474, 505, 557, 600, 653, 1000]
    ...
    for x in adjusted_sizes_x:
        for y in adjusted_sizes_y:
            ...
            if result:
                ...
                dictionary['width'] = browser.get_window_size().get("width") - delta_x
                dictionary['height'] = browser.get_window_size().get("height") - delta_y
                print(dictionary)
                result_code = result
                found = True
                break
